                      ...
                      <div class="media">
                        ...
                        <div class="media-body">
                          <a href="#">
                            ...
                            Order Placed on Sun, Mar 18, 6:12 PM
                            </span>
                          </a>
                          <h6 class="mb-2">
                            <a href="#"></a>
                            <a href="#" class="text-black">
                              Deliver using Alpha Drone
                            </a>
                          </h6>
                          <p class="text-black mb-1">Pickup Location: Mumbai</p>
                          <p class="text-black mb-3">Drop Location: Pune</p>
                          <p class="text-dark">
                      ...
                      <div class="media">
                        ...
                        <div class="media-body">
                          ...
                          <h6 class="mb-2">
                            <a href="#"></a>
                            <a href="#" class="text-black">
                              Deliver using Hammer Drone
                            </a>
                          </h6>
                          <p class="text-black mb-1">Pickup Location: Delhi</p>
                          <p class="text-black mb-3">Drop Location: Ghaziabad</p>
                          <p class="text-dark">
                    ...
                    <div class="p-4">
                      ...
                      <div class="media">
                        ...
                        <div class="media-body">
                          <a href="#">
                            <span class="float-right text-info">
                            Order Placed on Thu, Mar 15, 8:12 PM
                            </span>
                          </a>
                          <h6 class="mb-2">
                            <a href="#"></a>
                            <a href="#" class="text-black">
                              Deliver using Francis Drone
                            </a>
                          </h6>
                          <p class="text-black mb-1">Pickup Location: Varanasi</p>
                          <p class="text-black mb-3">Drop Location: Prayagraj</p>
                          <p class="text-dark">
                            Time Taken : 3.5 hours
                          </p>
                          <hr />
